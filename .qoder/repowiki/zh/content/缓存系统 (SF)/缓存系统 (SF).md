...
**更新** README.md 中的文档已大幅简化，移除了复杂的架构说明和实现细节，保留基本使用示例。

## 项目结构
- 核心模块位于 sf/sf.go，提供缓存接口、内存缓存实现、全局缓存注册、SingleFlight 并发合并与查询封装。
- 统一入口 gormplus_sf.go 将 SF 能力导出为 gormplus 包的公开 API，并提供默认 TTL、注册缓存、停止清理等便捷函数。
...
```mermaid
graph TB
A["应用代码"] --> B["gormplus_sf.go<br/>统一入口"]
...
**图表来源**
- [sf.go:1-761](file://sf/sf.go#L1-L761)
...
**章节来源**
- [sf.go:56-71](file://sf/sf.go#L56-L71)
- [sf.go:345-443](file://sf/sf.go#L345-L443)
- [sf.go:272-292](file://sf/sf.go#L272-L292)
- [sf.go:491-503](file://sf/sf.go#L491-L503)
- [sf.go:512-515](file://sf/sf.go#L512-L515)
- [sf.go:716-733](file://sf/sf.go#L716-L733)
- [sf.go:735-760](file://sf/sf.go#L735-L760)
- [sf.go:487](file://sf/sf.go#L487)
...
**图表来源**
- [sf.go:618-677](file://sf/sf.go#L618-L677)
...
- [sf.go:345-443](file://sf/sf.go#L345-L443)
- [sf.go:272-292](file://sf/sf.go#L272-L292)
- [sf.go:445-483](file://sf/sf.go#L445-L483)
...
**章节来源**
- [gormplus_sf.go:131-169](file://gormplus_sf.go#L131-L169)
...
- [sf.go:716-733](file://sf/sf.go#L716-L733)
- [sf.go:618-677](file://sf/sf.go#L618-L677)
- [sf.go:426-443](file://sf/sf.go#L426-L443)
...
- [sf.go:272-292](file://sf/sf.go#L272-L292)
- [sf.go:445-483](file://sf/sf.go#L445-L483)
- [sf.go:679-712](file://sf/sf.go#L679-L712)
...
**更新** README.md 中的文档已大幅简化，移除了复杂的架构说明和实现细节，保留基本使用示例，使文档更加简洁易懂。
